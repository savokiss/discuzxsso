...
class LoginForm extends SpecialPage {
	...
	function load() {
		...
		$this->mUsername = urldecode($request->getText( 'wpName' ));
...
//		echo "<script>alert('start auth!');</script>";
...
//		echo "<script>alert('try create:".$this->mUsername."');</script>";
...
//		echo "<script>alert('name usable:".$this->mUsername."');</script>";
		

		$isAutoCreated = false;
		if ( 0 == $u->getID() ) {
//			echo "<script>alert('attempt auto create:".$this->mUsername."');</script>";
...
//			echo "<script>alert('link ext user:".$this->mUsername."');</script>";
...
//		echo "<script>alert('start autoCreate!');</script>";
		 ...
		 */
		if ( $this->mExtUser ) {
//			echo "<script>alert('try ext user create!');</script>";
...
//			echo "<script>alert('try old user create!');</script>";
			# Old AuthPlugin.
...
//		echo "<script>alert('autocreate done:".self::SUCCESS."');</script>";
